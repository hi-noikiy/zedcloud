...
*/
    'core' => [
        ...
        'qiniu'=>[
            'accessKey'=>env('QINIU_KEY'),  //AccessKey
            'secretKey'=>env('QINIU_SECRET'),  //SecretKey
            'bucket'=>env('QINIU_BUCKET'),  //Bucket名字
            'url'=>env('APP_CDN'),//七牛分配的CDN域名,注意带上http://
        ]
    ],
    ...
    'upload' => [
        ...
        "imageMaxSize" => 1073741824, /* 上传大小限制，单位B */
        ...
        "fileMaxSize" => 1073741824, /* 上传大小限制，单位B，默认50MB */
        "fileAllowFiles" => [
