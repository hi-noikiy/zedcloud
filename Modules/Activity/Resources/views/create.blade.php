...
<script src="{{asset('js/datetimepicker.js')}}"></script>
    ...
    <div class="table-responsive">
        <form class="form-horizontal" method="post" action="{{ route('activity.activity.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
             ...
             <div class="form-group {{ $errors->has('combo_id') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="combo_id" value="{{ old('combo_id') }}">
            ...
            <div class="form-group {{ $errors->has('before_price') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input required type="text"  class="form-control" name="before_price" value="{{ old('before_price') }}">
            ...
            <div class="form-group {{ $errors->has('new_price') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input required type="text"  class="form-control" name="new_price" value="{{ old('new_price') }}">
            ...
            <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input required type="text" class="form-control" id="start_time" name="start_time" value="{{ old('start_time') }}">
            ...
            <div class="form-group {{ $errors->has('end_time') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input required type=text class="form-control" id="end_time" name="end_time" value="{{ old('end_time') }}">
            ...
            <div class="form-group {{ $errors->has('cover') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input required type="file" class="form-control" name="cover" value="{{ old('cover') }}">
                    @if ($errors->has('cover'))
                        <span class="help-block">
