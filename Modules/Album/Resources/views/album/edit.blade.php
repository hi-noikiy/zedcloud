...
@section('content')
    <div class="table-responsive">
        <form class="form-horizontal" method="post" action="{{ route('album.album.update', ['_album_id' => $album->_id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('cover') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="file" class="form-control" name="cover" value="{{ $album->cover }}">
                    @if ($errors->has('cover'))
            ...
            <div class="form-group {{ $errors->has('like') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="like" value="{{ $album->like }}">
                    @if ($errors->has('like'))
                        <span class="help-block">
