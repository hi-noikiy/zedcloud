...
function init() {	
    ...
    var sb = _U.getSubmit(update_init_url, null, "ajax", false);
    sb.submit(function () {
    }, function (data) {
    	//console.log(data);
...
function initPage(data) {
    ...
    works_view_uuid = worksmain.view_id;
...
function previewPano() {
    ...
    window.open(public_path + "tour/"+works_view_uuid);
}
