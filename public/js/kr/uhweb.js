...
(function (w, d, undefined) {
    ...
    if (_U.isDev) {
        _U.loadCss(public_path+'css/zui.min.css');
        _U.loadCss(public_path+'css/zui-theme.css');
        _U.loadCss(public_path+'css/fileinput.min.css');
        _U.loadCss(public_path+'css/bootstrap-switch.css');
        _U.loadCss(public_path+'css/chosen.min.css');
        _U.loadCss(public_path+'css/zui.datatable.min.css');   
        _U.loadCss(public_path+'css/response.css');
        _U.loadJs(public_path+'js/jquery-1.9.1.js');
        _U.loadJs(public_path+'js/zui.js?v=3.1');
        _U.loadJs(public_path+'js/bootstrap-switch.min.js?1');
        _U.loadJs(public_path+'js/chosen.js');
        _U.loadJs(public_path+'js/zui.datatable.min.js');
		_U.loadJs(public_path+'js/zui.sortable.min.js');
        _U.loadJs(public_path+'js/bootbox.js');
        _U.loadJs(public_path+'js/fileinput-v4.34.js');
        _U.loadJs(public_path+'js/fileinput_locale_zh.js');
         _U.loadJs(public_path+'js/common.js');
        _U.loadJs(public_path+'js/submit.js');
        _U.loadJs(public_path+'js/biz.js');
        _U.loadJs(public_path+'kindeditor/kindeditor-min.js');
        _U.loadCss(public_path+'kindeditor/themes/default/default.css');
